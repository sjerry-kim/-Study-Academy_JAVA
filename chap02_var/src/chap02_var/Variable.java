...
public class Variable {
	...
	public static void main(String[] args) {
		...
		long speedLight =30000;
		//print메소드안에 수식을 작성하면 계산하여 출력한다
		...
		// 실습 기호 상수 final
		// 정육면체의 한 변의 길이를 기호상수로 두고 계산
		final int LINE = 10;
		// 변수는 변수끼리 계산한 값도  할당할 수 있다
		int V = LINE* LINE * LINE;
		System.out.println(V);
		
		//Boolean 논리형 - 참, 거짓 두가지 값만 가지는 자료형
		boolean isRain = false; // 자바에서는 0과 같은 정수값은 넣을 수 없다
		System.out.println(isRain); //false로 출력되지만 boolean값이다.
		
		// 실습 논리형
		int num = 10;
		boolean check = (num>20); // 10>20 : 거짓
		System.out.println(check);
		
		// num 값을 30으로 수정하서 확인하기
		num = 30;
		...
		// int를 이용하여 (변수이름)number에 숫자값10을 할당하세요
		int number = 10;
